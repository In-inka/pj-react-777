...
`;Je.defaultProps={theme:{main:"rgba(239, 237, 232, 0.3)"}};const qo=K.button`
  /* position: absolute; */
  margin-right: 14px;
...
`;const Zo=({product:n,closeModal:t})=>{const r=Ze(),o=async e=>{const u=Math.round(n.calories/100*Number(e.weight)),l={productId:n._id,calories:u,amount:Number(e.weight)};try{await r(xn.postDiaryProduct(l)),at.success("Success!")}catch(i){at.error(i.message)}};return M.jsx(Qo,{onClick:t,children:M.jsxs(Go,{children:[M.jsx(Ko,{type:"button",onClick:t,children:M.jsx(Xo,{children:M.jsx("use",{href:`${ye}#icon-x`})})}),M.jsx(In,{initialValues:{weight:""},onSubmit:o,children:M.jsxs(Rn,{children:[M.jsx("label",{htmlFor:"title",children:M.jsx(st,{as:Je,type:"text",name:"product",placeholder:n.title,readOnly:!0})}),M.jsx("label",{htmlFor:"weight",children:M.jsx(st,{as:Je,type:"number",name:"weight",placeholder:"Weight, grams"})}),M.jsxs("p",{children:["Calories: ",n.calories]}),M.jsx(qo,{type:"submit",children:"Add to diary"}),M.jsx(Jo,{type:"button",onClick:t,children:"Cancel"})]})})]})})},ea=({products:n,fetching:t,totalPage:r})=>{const[o,e]=Wo({threshold:0}),[u,l]=C.useState(2),i=be(pn),a=be(hn),[s,c]=C.useState(),d=g=>{c(g)};return C.useEffect(()=>{e&&!a&&(l(u+1),t(i,u,10))},[t,e,a]),M.jsxs(wo,{children:[s&&M.jsx(Zo,{product:s,children:"form"}),(n==null?void 0:n.length)>0?n.map(g=>M.jsx(Vo,{product:g,addProductDetails:d},Yo())):M.jsx(Bo,{}),M.jsx("div",{ref:o,style:{width:"300px",height:"15px"}})]})},Vt="/pj-react-777/assets/products_background_desktop-55179e50.jpg",ta=re.div`
  ${An}
  margin-top: 61px;
  padding-top: 40px;
  padding-bottom: 80px;
...
`,ca=()=>{be(hn);const n=Ze(),t=be(Co);be(_t.getIsFetchingCurrentUser),C.useEffect(()=>{n(Qe())},[]);const r=C.useCallback((o,e,u)=>{try{n(o?ut({filterParams:o,page:e,limit:u}):ut({filterParams:o,page:e,limit:u}))}catch(l){console.log(l)}},[n]);return C.useEffect(()=>{localStorage.getItem("persist:products").filter===En.getInitialState().filter&&r()},[r]),M.jsxs(ta,{children:[M.jsx(ia,{children:"Filters"}),M.jsxs(ra,{children:[M.jsx(na,{children:"Products"}),M.jsx(So,{submit:r})]}),M.jsx(ea,{products:t,fetching:r})]})};export{ca as default};
