...
`;N.span`
  ...
  gap: 8px;
  align-items: center;
`;const pa=({product:n,getCalories:t})=>{const r=Ce(),[o,e]=C.useState(100),u=a=>{e(a.target.value)},l=async()=>{if(!o){st.error("Please add weight!");return}const a=Math.round(n.calories/100*Number(o)),s={productId:n._id,calories:a,amount:Number(o)};try{await r(yn.postDiaryProduct(s))}catch(c){st.error(c.message)}t(s.calories),r(tt.successOpenModal()),r(r(Ke.closeModal()))},i=a=>{a.target===a.currentTarget&&r(Ke.closeModal())};return w.jsx(na,{onClick:i,children:w.jsxs(ra,{children:[w.jsx(ia,{type:"button",onClick:i,children:w.jsx(oa,{children:w.jsx("use",{href:`${xe}#icon-x`})})}),w.jsx(Tn,{initialValues:{weight:""},onSubmit:l,children:w.jsxs(Vn,{children:[w.jsxs(aa,{children:[w.jsx(da,{htmlFor:"title",children:w.jsx(lt,{as:et,type:"text",name:"product",placeholder:n.title,readOnly:!0})}),w.jsx(fa,{htmlFor:"weight",children:w.jsx(lt,{as:et,type:"number",name:"weight",placeholder:"Weight, grams",onChange:u,value:o})})]}),w.jsxs(la,{children:["Calories:"," ",w.jsxs(ca,{children:[" ",Math.round(n.calories/100*o)]})]}),w.jsx(ua,{type:"submit",children:"Add to diary"}),w.jsx(sa,{type:"button",onClick:i,children:"Cancel"})]})})]})})},ha="/pj-react-777/assets/food-2x-1cf208a8.png",ma=N.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
