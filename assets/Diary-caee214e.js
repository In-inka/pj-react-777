...
`,E=({display:i})=>e.jsx("div",{style:{display:i,justifyContent:"center",width:"100%"},children:e.jsx(Q,{strokeColor:"grey",strokeWidth:"5",animationDuration:"0.75",width:"20%",visible:!0})}),ke=i=>i.diary.data,$e=i=>i.diary.isLoading,De=i=>i.diary.error,u={getDiary:ke,getIsLoading:$e,getIsError:De},W=n.svg`
  &.orange {
