...
`,$o=re.svg`
  ...
  padding: 3px 4px;
`,Vt=(n,t=24)=>{if(n.length>t){const r=n.lastIndexOf(" ",t);return r!==-1?Qe(n.substring(0,r))+"...":Qe(n.substring(0,t))+"..."}return Qe(n)};function Qe(n){return n.charAt(0).toUpperCase()+n.slice(1)}const Ho=({product:n,addProductDetails:t})=>{const r=()=>{t(n)},o=ge(En.getUserMetricData).blood;return S.jsxs(Ro,{children:[S.jsxs(_o,{children:[S.jsx(Lo,{children:S.jsx(ko,{children:"Diet"})}),S.jsxs("div",{style:{display:"flex"},children:[S.jsx(jo,{children:n.groupBloodNotAllowed[o]?S.jsxs(S.Fragment,{children:[S.jsx(Rt,{style:{backgroundColor:"#419B09"}}),S.jsx(Tt,{children:"Recommended"})]}):S.jsxs(S.Fragment,{children:[S.jsx(Rt,{style:{backgroundColor:"#E9101D"}}),S.jsx(Tt,{children:"Not recommended"})]})}),S.jsxs(Bo,{onClick:r,children:["Add",S.jsx("svg",{width:16,height:16,style:{stroke:"#E6533C"},children:S.jsx("use",{href:`${xe}#icon-start`})})]})]})]}),S.jsxs(To,{children:[S.jsx($o,{width:24,height:24,children:S.jsx("use",{href:`${xe}#icon-running`})}),Vt(n.title)]}),S.jsxs(Vo,{children:[S.jsxs(We,{children:[S.jsx(Ye,{children:"Calories: "}),n.calories]}),S.jsxs(We,{children:[S.jsx(Ye,{children:"Category: "}),Vt(n.category,13)]}),S.jsxs(We,{children:[S.jsx(Ye,{children:"Weight: "}),n.weight]})]})]})},zo=N.div`
  @media screen and (min-width: 375px) {
...
`,ya=N.svg`
    width: 16px;
    height: 16px;
    stroke: rgba(239, 237, 232, 0.3)`,Ca=({calories:n})=>{const t=Ce(),r=o=>{o.target===o.currentTarget&&t(tt.successcloseModal())};return S.jsx(pa,{onClick:r,children:S.jsxs(ha,{children:[S.jsx(ma,{onClick:r,children:S.jsx("use",{href:xe+"#icon-close"})}),S.jsxs(va,{children:[S.jsx(ga,{src:fa,alt:"product"}),S.jsx(ba,{children:"Well done"}),S.jsxs(Lt,{children:["Calories: ",S.jsx(xa,{children:n})]})]}),S.jsx(Ea,{onClick:r,children:"Next product"}),S.jsx(Cn,{to:"/diary",children:S.jsxs(Lt,{children:["To the diary",S.jsx(ya,{children:S.jsx("use",{href:xe+"#icon-start"})})]})})]})})},Sa=({products:n,fetching:t})=>{const[r,o]=C.useState(1),[e,u]=Jo({threshold:0}),l=ge(mn),i=ge(Fo),a=ge(Mo),s=C.useRef(),c=Number(ge(Do)),d=ge(Po),g=Ce(),[f,m]=C.useState(),[h,v]=C.useState();C.useEffect(()=>{g(tt.successcloseModal())},[]);const p=b=>{m(b),g(Ke.openModal())},x=()=>{const b=s.current.scrollHeight;s.current.scrollTop=b-b*.2},y=b=>v(b);return C.useEffect(()=>{u&&(o(c+1),x()),!a&&r!==c&&t(l,r,10)},[u]),S.jsxs(S.Fragment,{children:[i&&S.jsx(da,{product:f,getCalories:y}),d&&S.jsx(Ca,{calories:h}),S.jsxs(Io,{ref:s,children:[(n==null?void 0:n.length)>0?n.map(b=>S.jsx(Ho,{product:b,addProductDetails:p},Zo())):S.jsx(Yo,{}),S.jsx("div",{ref:e,style:{width:"300px",height:"15px"}})]})]})},kt="/pj-react-777/assets/products_background_desktop-55179e50.jpg",wa=re.div`
  ${Tn}
  margin-top: 61px;
  padding-top: 40px;
  padding-bottom: 80px;
