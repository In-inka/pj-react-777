import{N as L,g as i,q as v,j as e,s as t,d as O,r as l,t as N,u as x,O as _}from"./index-837f1c35.js";import{n as B}from"./emotion-styled.browser.esm-5c742298.js";import{C as D,s as h}from"./sprite-3b9c37cd.js";import{e as F,f as q}from"./main_bg_desktop-e1ac3f6f.js";import{e as p}from"./exercisesSelectors-80adadd9.js";import{L as M}from"./Loading-8bfef9a3.js";import W from"./ErrorPage-f46273f7.js";import"./Hourglass-74e64171.js";const G=B.div`
    display: flex;
    gap: 28px;
...
`,pe=({filter:n,openWindow:a})=>{const o=O();l.useEffect(()=>{o(N.getExercises())},[]);const c=x(p.getExercisesData),d=x(p.getIsLoading);x(p.getIsError);const g=c.filter(r=>r.bodyPart===n||r.target===n||r.equipment===n);return e.jsxs(te,{children:[d&&e.jsx(M,{}),!d&&g&&g.map(r=>e.jsxs(ie,{children:[e.jsx(ae,{children:"WORKOUT"}),e.jsx(ne,{id:r._id,type:"button",onClick:a,children:e.jsxs(re,{children:[e.jsx(oe,{children:"Start"}),e.jsx(se,{children:e.jsx("use",{href:`${h}#icon-start`})})]})}),e.jsxs(ce,{children:[e.jsx(de,{children:e.jsx("use",{href:`${h}#icon-running-exercises-page`})}),e.jsx(le,{children:r.name})]}),e.jsxs(xe,{children:[e.jsxs(j,{children:[e.jsx(k,{children:"Burned calories:"}),e.jsx(y,{children:r.burnedCalories})]}),e.jsxs(j,{children:[e.jsx(k,{children:"Body part:"}),e.jsx(y,{children:r.bodyPart})]}),e.jsxs(j,{children:[e.jsx(k,{children:"Target:"}),e.jsx(y,{children:r.target})]})]})]},r._id))]})},he=t.div`
    position: fixed;
    top: 0;
    left: 0;
    /* position: absolute; */
