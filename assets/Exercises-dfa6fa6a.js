import{N as S,g as n,n as B,j as e,s as t,d as L,r as l,q as O,u as m,O as N}from"./index-18acc384.js";import{n as v}from"./emotion-styled.browser.esm-24f460ff.js";import{C as _}from"./ContainerStyled-bb0b3bf9.js";import{b as D,a as q}from"./main_bg_desktop-12717d49.js";import{s as x}from"./sprite-635f82c8.js";import{e as b}from"./exercisesSelectors-80adadd9.js";import{L as F}from"./Loading-956eeaee.js";import"./Hourglass-2ec6e71a.js";const M=v.div`
    display: flex;
    gap: 28px;
...
`,W=()=>{const i=B();return e.jsxs(M,{children:[e.jsx(w,{to:"bodyParts",state:{from:i},children:"Body parts"}),e.jsx(w,{to:"muscles",state:{from:i},children:"Muscles"}),e.jsx(w,{to:"equipment",state:{from:i},children:"Equipment"})]})},G=t.div`
    ${_}
    padding-top: 101px;
    padding-bottom: 80px;
...
`,Ce=({data:i,onClose:a})=>{const r=i;return e.jsx(xe,{onClick:a,children:e.jsxs(pe,{children:[e.jsx(ve,{type:"button",onClick:a,children:e.jsx(ge,{children:e.jsx("use",{href:`${x}#icon-x`})})}),e.jsxs(he,{children:[e.jsx(ue,{children:e.jsx(me,{src:r.gifUrl,alt:"Gif-Exercises"})}),e.jsxs(be,{children:[e.jsx(fe,{children:"Time"}),e.jsx(je,{type:"button",children:e.jsx(ke,{children:e.jsx("use",{href:`${x}#icon-pause`})})}),e.jsxs(we,{children:["Burned calories: ",e.jsx(ye,{children:r.burnedCalories})]})]})]}),e.jsxs(Ee,{children:[e.jsxs(g,{children:[e.jsx(h,{children:"Name"}),e.jsx(u,{children:r.name})]}),e.jsxs(g,{children:[e.jsx(h,{children:"Target"}),e.jsx(u,{children:r.target})]}),e.jsxs(g,{children:[e.jsx(h,{children:"Target"}),e.jsx(u,{children:r.target})]}),e.jsxs(g,{children:[e.jsx(h,{children:"Body Parts"}),e.jsx(u,{children:r.bodyPart})]})]}),e.jsx(Be,{type:"button",children:"Add to diary"})]})})},Ne=()=>{const a=B().pathname,r=localStorage.getItem("CategoryName"),[c,d]=l.useState(!1),[p,o]=l.useState(""),C=m(b.getExercisesData),z=s=>{const f=s.currentTarget.id,I=C.filter(P=>P._id===f);o(I),d(!0)},E=()=>{console.log("Клік відбувся!"),d(!1)};l.useEffect(()=>{function s(f){f.key==="Escape"&&E()}return c&&window.addEventListener("keydown",s),()=>{window.removeEventListener("keydown",s)}},[c]);const T=s=>{if(s==="/exercises")return"backgroundPhoto"},$=s=>s==="/exercises"?`${r}`:s==="/exercises/bodyParts"?"Body Parts":s==="/exercises/muscles"?"Muscles":s==="/exercises/equipment"?"Equipment":"";return e.jsx(A,{className:T(a),children:e.jsxs(G,{children:[a==="/exercises"&&e.jsx(V,{}),e.jsxs(R,{children:[e.jsx(Y,{text:$(a)}),e.jsx(W,{})]}),c&&e.jsx(Ce,{data:p[0],onClose:E}),a==="/exercises"&&e.jsx(le,{filter:r,openWindow:z}),e.jsx(l.Suspense,{children:e.jsx(N,{})})]})})};export{Ne as default};
