...
`,he=({text:l,className:u})=>e.jsx(ce,{className:u,children:l}),xe=i.div`
  ${X};
  padding-top: 101px;
  padding-bottom: 66px;
...
`,$e=()=>{const l=L.useRef(null),u=m(g.getUserName),w=m(g.getUserAvatar),f=M(),{dailyIntakeCalories:F,dailyNormOfSport:S}=m(g.getUserMetricData),D=async W=>{const v=W.target.files[0];if(v){const j=new FormData;j.append("avatar",v),await f(A.updateUserAvatar(j)),f(A.fetchCurrentUser())}},z=()=>{f(A.logOut())};return e.jsxs(me,{children:[e.jsxs(ge,{children:[e.jsx(fe,{children:w?e.jsx(ue,{src:w,alt:"Avatar"}):e.jsx(p,{width:61,height:62,className:"user",children:e.jsx("use",{href:`${h}#icon-user`})})}),e.jsxs("div",{children:[e.jsx("input",{type:"file",accept:"image/*",style:{display:"none"},ref:l,onChange:D}),e.jsxs(ve,{onClick:()=>l.current.click(),children:[" ",e.jsx(p,{width:24,height:24,className:"lightOrange mark",children:e.jsx("use",{href:`${h}#icon-check_mark`})})]})]})]}),e.jsxs(je,{children:[e.jsx(be,{children:u}),e.jsx(ye,{children:"User"})]}),e.jsxs(we,{children:[e.jsxs(U,{children:[e.jsxs(R,{children:[e.jsx(p,{width:20,height:20,className:"orange",children:e.jsx("use",{href:`${h}#icon-fluent_food`})}),e.jsx("p",{children:"Daily calorie intake"})]}),e.jsx(V,{children:F})]}),e.jsxs(U,{children:[e.jsxs(R,{children:[" ",e.jsx(p,{width:20,height:20,className:"orange",children:e.jsx("use",{href:`${h}#icon-dumbbell`})}),e.jsx("p",{children:"Daily norm of sports"})]}),e.jsxs(V,{children:[S," min"]})]})]}),e.jsxs(Ce,{children:[e.jsxs("div",{children:[" ",e.jsx(p,{width:24,height:24,className:"orange",children:e.jsx("use",{href:`${h}#icon-exclamation-mark`})})]}),e.jsx("p",{children:"We understand that each individual is unique, so the entire approach to diet is relative and tailored to your unique body and goals."})]}),e.jsxs(ke,{type:"button",onClick:z,children:["Logout"," ",e.jsx(p,{width:24,height:24,className:"stroke",children:e.jsx("use",{href:`${h}#icon-logout`})})]})]})},We=()=>e.jsxs(xe,{children:[e.jsx(he,{text:"Profile Settings"}),e.jsxs(pe,{children:[e.jsx($e,{}),e.jsx(le,{})]})]});export{We as default};
