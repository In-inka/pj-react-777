import{N as Z,g as f,y as H,j as e,s as t,d as K,r as l,z as ee,u as T,A as te,R as I,L as F,h as ne,Q as N,O as ie}from"./index-59a48b20.js";import{n as Q}from"./emotion-styled.browser.esm-b368e9b6.js";import{C as re,s as E}from"./sprite-9d4b7003.js";import{e as oe,f as se}from"./main_bg_desktop-e1ac3f6f.js";import{e as B}from"./exercisesSelectors-80adadd9.js";import{L as ae}from"./Loader-c0003237.js";import ce from"./ErrorPage-afbbcd19.js";const le=Q.div`
    display: flex;
    gap: 28px;
...
`,Le=({filter:n,openWindow:i})=>{const o=K();l.useEffect(()=>{o(ee.getExercises())},[]);const s=T(B.getExercisesData),c=T(B.getIsLoading);T(B.getIsError);const a=s.filter(r=>r.bodyPart===n||r.target===n||r.equipment===n);return e.jsxs(ye,{children:[c&&e.jsx(te,{}),!c&&a&&a.map(r=>e.jsxs(ve,{children:[e.jsx(Be,{children:"WORKOUT"}),e.jsx(Ce,{id:r._id,type:"button",onClick:i,children:e.jsxs(Ee,{children:[e.jsx($e,{children:"Start"}),e.jsx(Te,{children:e.jsx("use",{href:`${E}#icon-start`})})]})}),e.jsxs(ze,{children:[e.jsx(Ie,{children:e.jsx("use",{href:`${E}#icon-running-exercises-page`})}),e.jsx(Se,{children:r.name})]}),e.jsxs(Pe,{children:[e.jsxs(W,{children:[e.jsx(A,{children:"Burned calories:"}),e.jsx(O,{children:r.burnedCalories})]}),e.jsxs(W,{children:[e.jsx(A,{children:"Body part:"}),e.jsx(O,{children:r.bodyPart})]}),e.jsxs(W,{children:[e.jsx(A,{children:"Target:"}),e.jsx(O,{children:r.target})]})]})]},r._id))]})},Re=t.div`
  position: fixed;
  top: 0;
  left: 0;
  /* position: absolute; */
