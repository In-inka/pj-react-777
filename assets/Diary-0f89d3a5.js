...
`,pi=()=>{const i=h(j.getDiary).doneExercises;return e.jsxs(Ee,{children:[e.jsxs(De,{children:[e.jsx(ze,{children:"Execrcises"}),e.jsxs(_e,{to:"/exercises",children:[e.jsx(Ie,{children:"Add exercise"}),e.jsx(W,{width:16,height:16,className:"orange",children:e.jsx("use",{href:`${x}#icon-start`})})]})]}),i.length?e.jsx(mi,{exercises:i}):e.jsx(gi,{})]})},mi=({exercises:i})=>{const a=k();return e.jsxs(e.Fragment,{children:[e.jsx(hi,{}),e.jsx(qe,{children:i.map(({burnedCalories:t,date:r,exerciseId:{bodyPart:s,equipment:d,name:o,target:m},time:c,_id:f})=>e.jsxs(He,{children:[e.jsxs(Se,{children:[e.jsx(w,{value:s,children:"Body Part"}),e.jsx(w,{value:d,children:"Equipment"}),e.jsx(w,{value:o,children:"Name"})]}),e.jsxs(Ne,{children:[e.jsxs(Be,{children:[e.jsx(w,{value:m,children:"Target"}),e.jsx(w,{value:t,children:"Burned Calories"}),e.jsx(w,{value:c,children:"Time"})]}),e.jsx(Ve,{onClick:()=>{a($.deleteDiaryExercise({exerciseId:f,date:r}))},children:e.jsx(Ae,{children:e.jsx(W,{width:20,height:20,className:"orange",children:e.jsx("use",{href:`${x}#icon-trash`})})})})]})]},f))})]})},w=({width:i,value:a,children:t})=>{let r=a,s=r;a.length>10&&(s=a.slice(0,10)+"...");let d=t,o=d;return t.length>10&&(o=t.slice(0,10)+"..."),e.jsxs(Pe,{name:t,children:[e.jsxs(We,{children:[e.jsx(Fe,{children:d}),e.jsx(Re,{children:o})]}),e.jsxs(Oe,{width:i,name:t,children:[e.jsx(Le,{children:r}),e.jsx(Me,{children:s})]})]})},hi=()=>e.jsxs(Ye,{children:[e.jsx(Ge,{children:"Body Part"}),e.jsx(Je,{children:"Equipment"}),e.jsx(Ke,{children:"Name"}),e.jsx(Qe,{children:"Target"}),e.jsx(Ze,{children:"Burned Calor..."}),e.jsx(Xe,{children:"Burned Calories"}),e.jsx(ei,{children:"Time"})]}),gi=()=>e.jsx(Ue,{children:"Not found exercises"}),ui=n.div`
  display: flex;
  max-width: 335px;
  justify-content: space-between;
  flex-wrap: wrap;
...
`,ji=()=>{const i=h(E.getUserMetricData).dailyIntakeCalories,a=h(E.getUserMetricData).dailyNormOfSport,t=h(j.getDiary).consumedCalories,r=h(j.getDiary).burnedCalories,s=i-t,d=a-h(j.getDiary).sportTime;return e.jsxs(ui,{children:[e.jsx(y,{value:i,children:"Daily calorie intake"}),e.jsx(y,{value:a,children:"Daily norm of sports"}),e.jsx(y,{value:t,children:"Calories consumed"}),e.jsx(y,{value:r,children:"Calories burned"}),e.jsx(y,{value:s,children:"The rest of the calories"}),e.jsx(y,{value:d,children:"The rest of sports"})]})},y=({value:i,children:a})=>{let t="",r=i;switch(a){case"Daily calorie intake":t=e.jsx(b,{width:20,height:20,className:"orange",children:e.jsx("use",{href:`${x}#icon-fluent_food`})});break;case"Daily norm of sports":t=e.jsx(b,{width:20,height:20,className:"orange",children:e.jsx("use",{href:`${x}#icon-dumbbell`})}),r=r.toString()+" min";break;case"Calories consumed":t=e.jsx(b,{width:20,height:20,className:"orange",children:e.jsx("use",{href:`${x}#icon-apple`})});break;case"Calories burned":t=e.jsx(b,{width:20,height:20,className:"orange",children:e.jsx("use",{href:`${x}#icon-calories`})});break;case"The rest of the calories":t=e.jsx(b,{width:20,height:20,className:"orange",children:e.jsx("use",{href:`${x}#icon-bubble`})});break;case"The rest of sports":t=e.jsx(b,{width:20,height:20,className:"orange",children:e.jsx("use",{href:`${x}#icon-running`})}),r=r.toString()+" min";break}return a==="The rest of sports"&&i<0&&(console.log(i),r="+ "+Math.abs(i).toString()+" min"),r||(r=0),e.jsxs(fi,{value:i,title:a,children:[e.jsxs(wi,{children:[t,e.jsx(bi,{children:a})]}),e.jsxs(yi,{children:[" ",r]})]})},vi=n.svg`
  &.orange {
    fill: ${({theme:i})=>i.secondaryOrange};
  }
`;function Ti(i){const a=i.getDate(),t=i.getMonth()+1,r=i.getFullYear();return`${a}/${t}/${r}`}const Si=()=>{const[i,a]=C.useState(new Date),t=k(),r=m=>{a(m)},s=h(j.getDiary),{eatenProducts:d,doneExercises:o}=s;return C.useEffect(()=>{t($.getDiary("?date="+Ti(i)))},[t,i,d.length,o.length]),e.jsxs(ii,{children:[e.jsxs(si,{children:[e.jsx(ni,{children:"Diary"}),e.jsxs(ti,{children:[e.jsx(ri,{children:e.jsx(z,{currentDate:i,handlerDate:r,textSize:18,textWeight:"bold",textHeight:20,sizeArrow:18,iconColor:l.secondaryOrange})}),e.jsx(ai,{children:e.jsx(z,{currentDate:i,handlerDate:r,textSize:24,textWeight:"bold",textHeight:32,sizeArrow:18,iconColor:l.secondaryOrange})})]})]}),e.jsxs(xi,{children:[e.jsxs(ci,{children:[e.jsx(ji,{}),e.jsxs(oi,{children:[e.jsx(Ci,{size:24}),e.jsx(di,{children:"Record all your meals in a calorie diary every day. This will help me be aware of my nutrition and make me responsible for my choices."})]})]}),e.jsxs(li,{children:[e.jsx(Te,{}),e.jsx(pi,{})]})]})]})},Ci=({size:i})=>e.jsx("div",{style:{width:`${i}px`,height:`${i}px`},children:e.jsx(vi,{width:i,height:i,className:"orange",children:e.jsx("use",{href:`${x}#icon-exclamation-mark`})})});export{Ci as IconInfo,Si as default};
