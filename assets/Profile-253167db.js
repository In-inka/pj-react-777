import{s as i,g as n,d as M,u,b as f,j as e,o as A,Q as F,r as Y}from"./index-920e286a.js";import{c as _,a as I,b as y,d as G,u as Q,B as J}from"./Button-b123568a.js";import{S as K,t as X,C as Z}from"./DaySwitch.styled-5c25499c.js";import{C as O,s as x}from"./sprite-18b3da65.js";import"./createClass-7e61f47a.js";const ee=i.form`
  padding-top: 18px;
...
`;i.input`
  ...
  letter-spacing: 0em;
  text-align: left;
`;const le=_().shape({name:I().required("Name is required"),height:y().min(150,"Height must be at least 150 cm").required("Height is required"),currentWeight:y().min(35,"Weight must be at least 35 kg").required("Current weight is required"),desiredWeight:y().min(35,"Weight must be at least 35 kg").required("Desired weight is required"),birthday:G().max(new Date(new Date().getFullYear()-18,new Date().getMonth(),new Date().getDate()),"Must be at least 18 years old").required("Birthday is required"),blood:y().oneOf([1,2,3,4],"Invalid blood type").required("Blood type is required"),sex:I().oneOf(["male","female"],"Invalid gender").required("Gender is required"),levelActivity:y().oneOf([1,2,3,4,5],"Invalid activity level").required("Activity level is required")}),ce=i.div`
  ${O};
  display: flex;
  flex-direction: column;
  justify-content: center;
